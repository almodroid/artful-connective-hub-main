    ...
    <Card className={cn("overflow-hidden border-border/40 bg-card/30 animate-scale-in hover:shadow-md transition-shadow duration-300 h-full", className)}>
      <CardContent className="p-0 relative h-full">
        ...
        <div className="relative bg-black h-full">
          ...
          {/* Action buttons container - moved to right side */}
          <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col items-center gap-3 p-3">
            {/* Like button */}
            <div className="flex flex-col items-center">
              <Button 
                ...
                size="icon" 
                className={cn(
                  "h-10 w-10 rounded-full bg-black/50 text-white hover:bg-black/70 transition-transform",
                  isLiked && "animate-pulse text-primary hover:text-primary transform-gpu scale-105"
                )}
                onClick={handleLike}
              >
                <Heart className={cn("h-6 w-6", isLiked && "fill-primary")} />
              </Button>
              <span className="text-sm text-white/90 mt-1">{likeCount}</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-white/90 mt-1">{reel.comments}</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm text-white/90 mt-1">{isRtl ? "مشاركة" : "Share"}</span>
            </div>
          </div>
