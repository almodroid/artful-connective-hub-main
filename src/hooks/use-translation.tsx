...
const translations = {
  en: {
    ...
    aiUsage: "AI Usage",
    requests: "requests",
    aiLimitReached: "You have reached your daily AI request limit.",
    buyCredits: "Buy Credits",
    unlimitedAIRequests: "Unlimited AI Requests",
    editWindowAlert: "You have 60 seconds to edit your post after publishing.",
    report: "Report",
    reportPost: "Report Post",
    reportProject: "Report Project",
    reportReason: "Please select a reason for reporting this content. Our team will review it.",
    spam: "Spam",
    theft: "Theft",
    other: "Other",
  ...
  ar: {
    ...
    requests: "طلبات",
    aiLimitReached: "لقد وصلت إلى الحد اليومي لطلبات الذكاء الاصطناعي.",
    buyCredits: "شراء رصيد",
    unlimitedAIRequests: "طلبات غير محدودة",
    editWindowAlert: "لديك 60 ثانية لتعديل منشورك بعد النشر.",
    report: "إبلاغ",
    reportPost: "الإبلاغ عن المنشور",
    reportProject: "الإبلاغ عن المشروع",
    reportReason: "يرجى اختيار سبب الإبلاغ عن هذا المحتوى. سيقوم فريقنا بمراجعته.",
    spam: "سبام / محتوى مزعج",
    theft: "سرقة / محتوى مسروق",
    other: "أخرى",
    selectReason: "اختر السبب",
    specifyReason: "يرجى توضيح السبب...",
